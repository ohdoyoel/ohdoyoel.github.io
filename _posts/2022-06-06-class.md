...
class library {
	std::vector<library_item*> catalogue;
public:
	library() : catalogue(std::vector()) {}
	void add_library_item(library_item const &);
	int how_many_overdue() const;
};
